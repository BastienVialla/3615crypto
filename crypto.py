...
def encrypt_ecc(message: str, curve_name: str = "SECP 256 R1") -> dict:
    ...
    private_components = int_to_bytes(priv_numbers.private_value)
...
def kyber_encrypt(
    ...
    return {"clé aes chiffrée": kem_ciphertext, "message chiffré": ciphertext},{"clé aes" : aes_key, "kyber clé publique": pk,"kyber clé secrète": sk}